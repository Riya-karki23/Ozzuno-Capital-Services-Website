...
export default function HomeHero() {
  return (
    ...
    >
      ...
      {/* orange slanted strip at bottom */}
      <div
        className="
          absolute
          bottom-0 left-0
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-6 md:px-10 lg:px-16 py-12 md:py-0">
        <div className="max-w-xl space-y-4 md:space-y-0">
          ...
          <button className="mt-32 inline-flex items-center gap-4 bg-black text-white px-6 md:px-8 py-3 md:py-3.5 rounded-4xl text-base md:text-lg font-semibold tracking-wide">
            See how
